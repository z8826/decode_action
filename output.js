//Fri Sep 20 2024 07:45:45 GMT+0000 (Coordinated Universal Time)
  ...
  async request(_0x2d54f0) {
    ...
    while (_0x29e06d < _0x12175d) {
      try {
          ...
          if (_0x1122ff.includes(_0x361aec)) {
            ...
            if (_0x4131b1.includes(_0x38be75)) {
              ...
              if (_0x30b6b0.includes(_0x361aec)) {
                ...
                if (_0x32f105) {
                  if (_0x40c29d > 3 && !_0x340989.includes(_0x32f105)) {
                    if (_0x32f105) {
                      this.log("请求[" + _0x3b9b1f + "]返回[" + _0x32f105 + "]");
                    } else {
        ...
        if (_0x2514fe.name == "TimeoutError") {
          this.log("[" + _0x3b9b1f + "]请求超时，重试第" + _0x29e06d + "次");
        } else {
          this.log("[" + _0x3b9b1f + "]请求错误(" + _0x2514fe.message + ")，重试第" + _0x29e06d + "次");
        }
      }
    }
    if (_0x1baa68 == null) {
    ...
    try {
      ...
      if (_0x510b4c?.["success"]) {
        ...
        for (let _0x14a2bd of _0x34364a) {
          ...
          if (_0x4b91a7 === "1" && _0x30bb3a >= 12) {
            _0x19a0c0.push(_0x4d41de + ", 过期时间: " + _0x26d322);
          }
        }
        if (_0x19a0c0.length) {
          const _0x5b35e1 = {
  ...
  async bee_indexData(_0xc5b874 = {}) {
    try {
      ...
      if (_0x120b3a?.["success"]) {
        if (_0x120b3a?.["obj"]?.["friendAwards"]?.["length"]) {
          this.log("获得奖励: " + _0x120b3a.obj.friendAwards.map(_0x25a948 => _0x25a948.name).join(","));
        }
  ...
  async memberDay_invite(_0x32bfe6 = {}) {
    try {
      ...
      if (_0x15e15d?.["success"]) {
        ...
        if (_0x1057c1) {
          await this.memberDay_receiveInviteAward(_0x3bc0ad);
        }
    ...
    try {
      ...
      if (_0x9f0a3d?.["success"]) {
        for (let _0x2c353f of _0x9f0a3d?.["obj"] || []) {
          ...
          if (_0x2c353f.receiveHour == _0xed759e) {
            await this.memberDay_receiveRedPacket(_0x2c353f.receiveHour);
          }
        }
      } else {
    ...
    try {
      ...
      if (_0x20777e?.["success"]) {
        ...
        for (let _0x9b80fd in this.memberDay_redPacket_map) {
          ...
          if (_0x5cb179 < _0x5e2492) {
            _0x5a7462 += 1 << _0x5cb179 - 1;
          }
        }
        const _0x57d247 = {
          notify: true
    ...
    try {
      ...
      if (_0x3b9b6e?.["success"]) {
        ...
        if (turnedAward?.["couponName"]) {
          _0x588072.push("[优惠券]" + turnedAward?.["couponName"]);
        }
        ...
        if (_0x1ca6c2?.["includes"]("用户手机号校验未通过")) {
  ...
  async jika2024_getAward(_0x49a8db, _0x36d0ec = {}) {
    try {
      ...
      if (_0x7b67a8?.["success"]) {
        ...
        if (turnedAward?.["couponName"]) {
          _0x1a6826.push("[优惠券]" + turnedAward?.["couponName"]);
        }
        ...
        if (_0x1f4210?.["includes"]("用户手机号校验未通过")) {
          this.jika_black = true;
        }
      }
    } catch (_0x1699d4) {
    ...
    try {
      ...
      if (_0x4fa60e?.["success"]) {
        ...
        for (let _0xdca95e of this.cards) {
          if (_0x171858.includes(_0xdca95e.currency)) {
            _0xdca95e.balance -= 1;
          }
        }
      } else {
  ...
  async anniversary2024_weeklyGiftStatus(_0x41c300 = {}) {
    try {
      ...
      if (_0x188284?.["success"]) {
        ...
        for (let _0xc64ed1 of _0x3d6ce0) {
          if (!_0xc64ed1.received) {
            let _0x1e983 = new Date(_0xc64ed1.receiveStartTime),
              ...
              _0x711f7e = Date.now();
            if (_0x711f7e >= _0x1e983.getTime() && _0x711f7e <= _0x9a0d2.getTime()) {
        ...
        if (_0x3d1b7f?.["includes"]("系统繁忙") || _0x3d1b7f?.["includes"]("用户手机号校验未通过")) {
  ...
  async anniversary2024_receiveWeeklyGift(_0x2d0aba = {}) {
    try {
      ...
      if (_0x2eea5c?.["success"]) {
        ...
        if (_0x4047bd?.["includes"]("系统繁忙") || _0x4047bd?.["includes"]("用户手机号校验未通过")) {
          this.anniversary_black = true;
        }
      }
    } catch (_0x3ed19e) {
    ...
    try {
      ...
      if (_0xca6f49?.["success"]) {
        ...
        if (turnedAward?.["productName"]) {
          _0xc01fe6.push("[优惠券]" + turnedAward?.["productName"]);
        }
        ...
        if (_0x4b5251?.["includes"]("用户手机号校验未通过")) {
          this.anniversary_black = true;
        }
      }
    } catch (_0x45063c) {
  ...
  async anniversary2024_unbox(_0x4082b8 = {}) {
    try {
      ...
      if (_0x17f829?.["success"]) {
        ...
        if (_0x1090e8?.["includes"]("用户手机号校验未通过")) {
          this.anniversary_black = true;
        }
      }
    } catch (_0x5988da) {
  ...
  async anniversary2024_game_list(_0x35d047 = {}) {
    try {
      ...
      if (_0x3ce51f?.["success"]) {
        ...
        if (_0x45d40b?.["includes"]("用户手机号校验未通过")) {
          this.anniversary_black = true;
        }
      }
    } catch (_0x575a85) {
      ...
      if (_0x11f142?.["success"]) {
        ...
        if (_0x3bcacf.length > 0) {
          ...
          if (_0xd15f27.answerStatus) {
            ...
            if (_0x191614?.["answer"]?.[_0x94c57d]) {
              await this.anniversary2024_answer(_0xd15f27, _0x4e64b9);
            }
          }
        } else {
    ...
    try {
      ...
      if (_0x26491b.length == 9) {
        ...
        if (_0x26491b.length >= 7) {
          ...
          if (_0x26491b.length >= 5) {
            ...
            if (_0x26491b.length >= 3) {
              _0x26491b = _0x26491b.slice(0, 3);
            }
          }
        }
      }
      ...
      if (_0x2c5b25?.["success"]) {
        ...
        for (let _0x4884d7 of this.cards) {
          if (_0x26491b.includes(_0x4884d7.currency)) {
            _0x4884d7.balance -= 1;
          }
        }
      } else {
  ...
  async dragonBoat2024_weeklyGiftStatus(_0x18f22f = {}) {
    try {
      ...
      if (_0x3db477?.["success"]) {
        ...
        for (let _0x4b1063 of _0x13cd21) {
          if (!_0x4b1063.received) {
            let _0x43651e = new Date(_0x4b1063.receiveStartTime),
              ...
              _0x21d4d7 = Date.now();
            if (_0x21d4d7 >= _0x43651e.getTime() && _0x21d4d7 <= _0x4b5537.getTime()) {
        ...
        if (_0x20d9e6?.["includes"]("系统繁忙") || _0x20d9e6?.["includes"]("用户手机号校验未通过")) {
  ...
  async dragonBoat2024_receiveWeeklyGift(_0x5bc16d = {}) {
    try {
      ...
      if (_0x50ef06?.["success"]) {
        ...
        if (_0x144c1b?.["includes"]("系统繁忙") || _0x144c1b?.["includes"]("用户手机号校验未通过")) {
          this.dragonBoat_black = true;
        }
      }
    } catch (_0xca3099) {
  ...
  async dragonBoat2024_fetchMixTaskReward(_0x49119b, _0x53f3de = {}) {
    try {
      ...
      if (_0x4874b8?.["success"]) {
        ...
        if (_0xc00e11?.["includes"]("用户手机号校验未通过")) {
          this.dragonBoat_black = true;
        }
      }
    } catch (_0x12ee97) {
  ...
  async dragonBoat2024_game_indexInfo(_0x432c38 = {}) {
    try {
      ...
      if (_0xdb99?.["success"]) {
        ...
        if (_0xa085a9?.["includes"]("用户手机号校验未通过")) {
          this.dragonBoat_black = true;
        }
      }
    } catch (_0x30d62a) {
  ...
  async dragonBoat2024_game_init(_0x308c0e, _0x46162c = {}) {
    try {
      ...
      if (_0x1b8b44?.["success"]) {
        ...
        if (_0x2026fa?.["includes"]("用户手机号校验未通过")) {
          this.dragonBoat_black = true;
        }
      }
    } catch (_0x8233a4) {
...
async function _0x28938e(_0x40c2b6 = 0) {
  ...
  try {
    ...
    if (_0x3ca429 != 200) {
      if (_0x40c2b6++ < MAX_AUTH_RETRY) {
        _0x241e9b = await _0x28938e(_0x40c2b6);
      }
      return _0x241e9b;
    }
    if (_0x45740c?.["code"] == 0) {
      ...
      if (_0x45740c?.["commonMsg"] && _0x45740c.commonMsg.length > 0) {
        _0xd20dff.log(_0x45740c.commonMsg.join("\n") + "\n");
      }
...
async function _0x313045() {
  ...
  try {
    ...
    if (_0x2f6355?.["code"] == 0) {
      _0x2f6355 = JSON.parse(_0x2f6355.data.file.data);
      _0x1dd0c5 = _0x2f6355?.["inviteUserId"] || _0x1dd0c5;
      _0x191614 = _0x2f6355?.["anniversary_2024"] || _0x191614;
    }
  } catch (_0x4b9ec7) {
...
function _0x1a99ad(_0x14860) {
  return new class {
    ...
    get(_0x497d1e, _0x3d2e5e, _0x49727e = "") {
      ...
      if (_0x497d1e?.["hasOwnProperty"](_0x3d2e5e)) {
        _0x496b18 = _0x497d1e[_0x3d2e5e];
      }
      return _0x496b18;
    }
    pop(_0x7e6e56, _0x506847, _0x5c2fd1 = "") {
      let _0x57b053 = _0x5c2fd1;
      if (_0x7e6e56?.["hasOwnProperty"](_0x506847)) {
        _0x57b053 = _0x7e6e56[_0x506847];
        delete _0x7e6e56[_0x506847];
      }
      return _0x57b053;
    }
    copy(_0x81274d) {
    ...
    time(_0x1fa95d, _0x35f59e = null) {
      ...
      if (/(y+)/.test(_0x1fa95d)) {
        _0x1fa95d = _0x1fa95d.replace(RegExp.$1, (_0x55b23e.getFullYear() + "").substr(4 - RegExp.$1.length));
      }
      for (let _0x1b02b3 in _0xccd715) if (new RegExp("(" + _0x1b02b3 + ")").test(_0x1fa95d)) {
        _0x1fa95d = _0x1fa95d.replace(RegExp.$1, 1 == RegExp.$1.length ? _0xccd715[_0x1b02b3] : ("00" + _0xccd715[_0x1b02b3]).substr(("" + _0xccd715[_0x1b02b3]).length));
      }
      return _0x1fa95d;
    }
    async showmsg() {
    ...
    normalize_time(_0x707c42, _0x2e4486 = {}) {
      ...
      if (_0x67c2c0 > _0xc8d206) {
        _0x707c42 = _0x707c42.slice(0, 13);
      }
    ...
    async wait_gap_interval(_0x50ce0f, _0x59fc2c) {
      ...
      if (_0x2e3b2c < _0x59fc2c) {
        await this.wait(_0x59fc2c - _0x2e3b2c);
      }
    }
  }(_0x14860);
}